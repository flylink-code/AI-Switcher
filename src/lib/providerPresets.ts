...
export const PROVIDER_PRESETS: ProviderPreset[] = [
  ...
  },
  {
    ...
    failoverModels: ["claude-sonnet-5", "gemini-3.8-flash"],
    notes:
      "9527CODE OpenAI-compatible gateway; Claude Fable 5.1 uses a 1M context / 128K output limit. Confirm the enabled model catalog before use",
    targets: CODE_DESKTOP,
  },
  {
    ...
    model: "claude-fable-5.1",
    modelContextWindow: 1_000_000,
    failoverModels: ["claude-sonnet-5", "gpt-5.6-sol"],
    notes:
      "AICodeWith OpenAI-compatible gateway; Claude Fable 5.1 uses a 1M context / 128K output limit. Confirm the enabled model catalog before use",
  ...
  },
  {
    ...
    model: "gpt-5.6-sol",
    modelContextWindow: 1_000_000,
    notes: "AICodeWith OpenAI Responses endpoint for Codex",
    targets: ["codex"],
  },
  {

...
**This release:** Antigravity account selection is family-hard (Claude vs Gemini). Empty Claude pools degrade to Gemini. Smart-gateway mode fallbacks always apply, including across upstreams on 429. Otherwise same as 1.5.3.

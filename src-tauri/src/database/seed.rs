...
const DEFAULT_PRICING: &[DefaultPricing] = &[
    ...
    DefaultPricing { provider: "Moonshot/Kimi", model: "k3", input: 20.0, cache_read: 2.0, cache_write: 0.0, output: 100.0, batch_input: 0.0, batch_output: 0.0, currency: "CNY", source_url: "https://platform.kimi.ai/docs/pricing/chat-k3" },
    DefaultPricing { provider: "Moonshot/Kimi", model: "k3-256k", input: 20.0, cache_read: 2.0, cache_write: 0.0, output: 100.0, batch_input: 0.0, batch_output: 0.0, currency: "CNY", source_url: "https://platform.kimi.ai/docs/pricing/chat-k3" },
    ...
    DefaultPricing { provider: "Moonshot/Kimi", model: "k2.6", input: 6.5, cache_read: 0.0, cache_write: 0.0, output: 27.0, batch_input: 0.0, batch_output: 0.0, currency: "CNY", source_url: "https://platform.kimi.com/" },

...
use crate::commands::{
    ...
    set_antigravity_outbound_proxy, set_antigravity_reasoning_level, start_antigravity_gateway, start_antigravity_oauth_login,
    ...
    get_skill_repository, get_skill_repository_snapshot, ignore_unmanaged_skill, list_github_repository_skills, refresh_github_repository_skills, register_unmanaged_skill, scan_unmanaged_skills, set_skill_repository, update_github_skills, list_mcp_servers, list_prompts,
    ...
    set_skill_enabled, start_proxy, stop_proxy, switch_provider, switch_to_official, speedtest_provider_endpoint, test_provider_connection, test_provider_input,
...
pub fn run() {
    ...
    let builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            set_antigravity_reasoning_level,

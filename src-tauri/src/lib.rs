...
use crate::commands::{
    ...
    simulate_gateway_route, list_gateway_upstream_health, get_smart_gateway_inbound_limits,
    ...
    check_localization_upstream, get_localization_hub_status, install_claude_code_localization, install_editor_localization_helper,
...
pub fn run() {
    ...
    let builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            get_codex_output_profile,
            set_codex_output_profile,
            list_codex_plugins,
            ...
            update_claude_code_localization,
            uninstall_claude_code_localization,
            install_editor_localization_helper,
            update_editor_localization_helper,
            uninstall_editor_localization_helper,
            update_desktop_localization,
            list_providers,
            get_provider_quota,
            get_official_quota,
            ...
            get_claude_desktop_app_status,
            run_claude_desktop_app_update,
            get_dsh_cli_version,
            run_dsh_cli_update,
            start_dsh_web,
